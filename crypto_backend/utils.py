...
def train_test_generator(X,test_sets=20,train_size=235,test_size=15,step = 3):
    # This train test generator takes approx 2 years of data input into the function
    # It then makes 20 5-month-long train_test_split sets where the first 3 month is train and last month is test
